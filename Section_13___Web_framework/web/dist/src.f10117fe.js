...
function () {
  function Model(attributes, events, sync) {
    ...
    this.events = events;
    this.sync = sync; // computed property. Typescript calls this accessors
    ...
    this.fetch = function () {
      var id = _this.attributes.get('id'); // if we don't have an any, this user is not in the db
    ...
    this.save = function () {
      var userData = _this.attributes.getAll();

      _this.sync.save(userData).then(function (resposne) {
        _this.trigger('save');
      }).catch(function () {
        _this.trigger('error');
      });
...
function () {
  function Attributes(data) {
    ...
    this.data = data; // in typesript, a string can be a type of itself. So, if we use
...
exports.Attributes = Attributes; // Example
...
},{"./../utils":"node_modules/axios/lib/utils.js","./../core/settle":"node_modules/axios/lib/core/settle.js","./../helpers/cookies":"node_modules/axios/lib/helpers/cookies.js","./../helpers/buildURL":"node_modules/axios/lib/helpers/buildURL.js","../core/buildFullPath":"node_modules/axios/lib/core/buildFullPath.js","./../helpers/parseHeaders":"node_modules/axios/lib/helpers/parseHeaders.js","./../helpers/isURLSameOrigin":"node_modules/axios/lib/helpers/isURLSameOrigin.js","../core/createError":"node_modules/axios/lib/core/createError.js"}],"../../../../../.nvm/versions/node/v12.16.0/lib/node_modules/parcel-bundler/node_modules/process/browser.js":[function(require,module,exports) {
...
},{"./utils":"node_modules/axios/lib/utils.js","./helpers/normalizeHeaderName":"node_modules/axios/lib/helpers/normalizeHeaderName.js","./adapters/xhr":"node_modules/axios/lib/adapters/xhr.js","./adapters/http":"node_modules/axios/lib/adapters/xhr.js","process":"../../../../../.nvm/versions/node/v12.16.0/lib/node_modules/parcel-bundler/node_modules/process/browser.js"}],"node_modules/axios/lib/core/dispatchRequest.js":[function(require,module,exports) {
'use strict';
...
function () {
  function Eventing() {
    var _this = this; // events is an object which its keys are strings that
...
var Eventing_1 = require("./Eventing"); // K is the Interface
...
function (_super) {
  ...
  User.buildUser = function (attrs) {
    return new User(new Attributes_1.Attributes(attrs), new Eventing_1.Eventing(), new ApiSync_1.ApiSync(ROOT_URL));
  };
...
var users = new Collection_1.Collection(rootUrl, function (json) {
...
users.fetch();
},{"./models/User":"src/models/User.ts","./views/UserList":"src/views/UserList.ts","./models/Collection":"src/models/Collection.ts"}],"../../../../../.nvm/versions/node/v12.16.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
